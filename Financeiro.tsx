      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollContent}>
        ...
        {isLoading ? (
          ...
          <>
            ...
            {/* Gráfico mês a mês, igual ao web: barras agrupadas Entradas
                (verde) / Saídas (vermelho) por mês. Usamos BarChart (não
                LineChart) porque barras não têm o bug de "n-1 pontos" que a
                linha tem quando sobra 1 mês só (janela "Mês"). */}
            <View style={fnStyles.dreCard}>
              ...
              <BarChart
                ...
                formatYLabel={(label: string) => `${Math.round(Number(label) / 1000)}k`}
                noOfSections={4}
                initialSpacing={8}
                endSpacing={8}
                yAxisThickness={0}
